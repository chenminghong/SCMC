...
- (void)getDataFromNet {
    /*
     [BiddingCheckingModel getDataWithOperation:ALREADY_BIDDING_DETAIL_API parameters:@{@"phoneNumber":[LoginModel shareLoginModel].phone, @"bidCode":self.bidCode} endBlock:^(id model, NSError *error) {
     if (!error) {
