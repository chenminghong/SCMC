...
@implementation OrderStatus145Cell
...
+ (instancetype)getCellWithTable:(UITableView *)table indexPath:(NSIndexPath *)indexPath {
    OrderStatus145Cell *cell = [table dequeueReusableCellWithIdentifier:@"OrderStatus145Cell"];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"OrderStatus145Cell" owner:self options:nil] firstObject];
    }
