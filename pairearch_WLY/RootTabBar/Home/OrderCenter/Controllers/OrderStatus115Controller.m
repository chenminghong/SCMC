...
@interface OrderStatus115Controller ()<UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) UITableView *tableView;

@end

@implementation OrderStatus115Controller
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    OrderStatus115Cell *cell = [OrderStatus115Cell getCellWithTable:tableView indexPath:indexPath];
