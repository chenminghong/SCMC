...
@interface OrderStatus150Controller ()<UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) UITableView *tableView;

@end

@implementation OrderStatus150Controller
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    OrderStatus150Cell *cell = [OrderStatus150Cell getCellWithTable:tableView indexPath:indexPath];
