//
//  DifferentWarehousesController.m
//  pairearch_WLY
//
...
@interface DifferentWarehousesController ()<UITableViewDelegate, UITableViewDataSource>
@property (strong, nonatomic) UITableView *tableView;

@end

@implementation DifferentWarehousesController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    DifferentWarehousesCell *cell = [DifferentWarehousesCell getCellWithTable:tableView indexPath:indexPath];
...
- (void)photoStartLoadButtonAction:(CustomVerticalButton *)sender {
    ...
    for (id statusStr in self.selectedModel.processList) {
        if ([statusStr integerValue] == ORDER_STATUS_152) {
